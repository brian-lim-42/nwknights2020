        ...
        if (nHit>0)
        {
           ...
           if (nHit ==2)
           {
               ...
               if (MySavingThrow(SAVING_THROW_FORT,oTarget, nDC, SAVING_THROW_TYPE_COLD,OBJECT_SELF) == 0)
               {
                    ...
                    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_FROST_L),oTarget, RoundsToSeconds(2));
               }
        ...
        if (nHit>0)
        {
           ...
           if (nHit ==2)
           {
               ...
               if (MySavingThrow(SAVING_THROW_FORT,oTarget, nDC, SAVING_THROW_TYPE_NONE,OBJECT_SELF) == 0)
               {
                    ...
                    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_SLOW),oTarget, RoundsToSeconds(2));
               }
        ...
        if (nHit>0)
        {
           ...
           if (nHit ==2)
           {
               ...
               if (MySavingThrow(SAVING_THROW_FORT,oTarget, nDC, SAVING_THROW_TYPE_NONE,OBJECT_SELF) == 0)
               {
                    ...
                    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_FLAME_M),oTarget, RoundsToSeconds(2));
               }
