...
float fDur   = 10.0; // Duration in seconds -- Change this to however long you want Time Stop to last Uncomment and Comment out 3rd ed duration
...
float fDist    = 6.0; // Radius in meters -- for a wider area of affect increase this float
...
*/
    ...
    AssignCommand(GetModule(),ApplyEffectToObject(DURATION_TYPE_TEMPORARY,EffectCutsceneParalyze(),oEffector,fDur));
...
*/
    ...
    ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_FNF_TIME_STOP), GetSpellTargetLocation(), fDur);
}
