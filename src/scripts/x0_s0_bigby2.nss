...
/*
    ...
    [pentagon] Bigbys Forceful Hand - Should last 2 rounds .
*/
//:://////////////////////////////////////////////
//:: Created By: Brent
        ...
        if(!MyResistSpell(OBJECT_SELF, oTarget))
        {
          ...
          //  {
            ...
            if (nCasterRoll >= nTargetRoll)
            {
                ...
                //Apply the penalty
                ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eKnockdown2, oTarget, RoundsToSeconds(1));
                DelayCommand ( 1.0, ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eKnockdown, oTarget, RoundsToSeconds(nDuration)));
