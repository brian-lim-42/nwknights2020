...
void main()
{
    ...
    {
        ClearAllActions();
        object oAlternative = GetObjectByTag ("SilverSupply01");
        object oAlternati02 = GetObjectByTag ("SilverSupply02");
        ...
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternati02, "silversupply"));
        }
        else
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternative, "silversupply"));
        }
        SetFacingPoint (GetPosition (oShouter));
        PlaySound ("vs_ngulnanf_hi");
