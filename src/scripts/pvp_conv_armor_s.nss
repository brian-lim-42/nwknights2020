...
void main()
{
    ...
    {
        ClearAllActions();
        object oAlternative = GetObjectByTag ("SilverArmor01");
        object oAlternati02 = GetObjectByTag ("SilverArmor02");
        ...
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternati02, "silverarmory"));
        }
        else
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternative, "silverarmory"));
        }
