...
void DetermineCombatRound(object oIntruder = OBJECT_INVALID, int nAI_Difficulty = 10)
{
    ...
    // start NWNight shadow_in_the_dark:
    // avoid attacking of unseen targets
    if ( ! GetObjectSeen ( oIntruder ) )
    {
        // ----------------------------------------------------------------------------------------
        // NPC shall stop attacking successful hiden enemies
        // Watchman shall change to attackable targets
        // ----------------------------------------------------------------------------------------
        return;
    }
    // end NWKnight
