...
void main()
{
    ...
    {
        ClearAllActions();
        object oAlternative = GetObjectByTag ("GoldWeaponry01");
        object oAlternati02 = GetObjectByTag ("GoldWeaponry02");
        ...
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternati02, "goldweaponry"));
        }
        else
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternative, "goldweaponry"));
        }
