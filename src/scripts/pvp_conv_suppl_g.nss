...
void main()
{
    ...
    {
        ClearAllActions();
        object oAlternative = GetObjectByTag ("GoldSupply01");
        object oAlternati02 = GetObjectByTag ("GoldSupply02");
        ...
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternati02, "goldsupply"));
        }
        else
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternative, "goldsupply"));
        }
