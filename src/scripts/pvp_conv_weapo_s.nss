...
void main()
{
    ...
    {
        ClearAllActions();
        object oAlternative = GetObjectByTag ("SilverWeaponry01");
        object oAlternati02 = GetObjectByTag ("SilverWeaponry02");
        ...
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternati02, "silverweaponry"));
        }
        else
        {
        AssignCommand (oShouter, ActionStartConversation(oAlternative, "silverweaponry"));
        }
        SetFacingPoint (GetPosition (oShouter));
        PlaySound ("vs_nkarlatm_hi");
