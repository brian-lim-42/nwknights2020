...
//Added for caster level calc
    int nCalc = GetCasterLevel(OBJECT_SELF);
/////////////////////////////
    int nCasterLvl = nCalc / 3;
    ...
    if(GetIsObjectValid(oMyWeapon) )
    {
        ...
        if (nDuration>0)
        {
            ...
            AddGreaterEnhancementEffectToWeapon(oMyWeapon, (RoundsToSeconds(nDuration)), nCasterLvl);
